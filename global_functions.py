        ...
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_w and not snabe1.moving_down:
                ...
                if snabe1_notFirstMove:
                    turning_point_x = snabe1.head_rect.centerx
                    turning_point_y = snabe1.head_rect.centery
            ...
            if event.key == pygame.K_UP and not snabe2.moving_down:
                ...
                if snabe2_notFirstMove:
                    turning_point_x = snabe2.head_rect.centerx
                    turning_point_y = snabe2.head_rect.centery
